...
def attack(char_name: str, char_class: Optional[str]) -> str:
    """Генерирует количество урона, наносимого определенным типом персонажа."""
...
def defence(char_name: str, char_class: Optional[str]) -> str:
    """Генерирует количество урона, блокируемое определенным тип персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: Optional[str]) -> str:
    """Применяет специальное умение в зависимости от типа персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: Optional[str]) -> str:
    """Предлагает совершить действие персонажу."""
    if char_class == 'warrior':
...
def choice_char_class() -> Optional[str]:
    """Выводит описание выбранного типа персонажа."""
